package com.happyabc.servlet;

import com.happyabc.dao.ResourceDao;
import com.happyabc.dao.impl.ResourceDaoImpl;
...
public class ResourceServlet extends HttpServlet {
    ...
    private void loadTree(HttpServletRequest request,
        ...
        try {
            ...
            List<Tree> treelist = this.rdao.getChildrenByParentId(id);
